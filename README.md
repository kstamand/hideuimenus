...
```Shell
/usr/sbin/curl --retry 3 "https://raw.githubusercontent.com/kstamand/hideuimenus/master/hideuimenus" -o "/jffs/addons/hideuimenus/hideuimenus" --create-dirs && chmod +x /jffs/addons/hideuimenus/hideuimenus && sh /jffs/addons/hideuimenus/hideuimenus install
```
